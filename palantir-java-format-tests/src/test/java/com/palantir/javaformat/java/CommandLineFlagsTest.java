...
public class CommandLineFlagsTest {
    ...
    public void stdinAndFiles() {
        try {
            ...
            assertThat(e).hasMessageContaining("cannot format from standard input and files simultaneously");
        }
    }
    ...
    public void inPlaceStdin() {
        try {
            ...
            assertThat(e).hasMessageContaining("in-place formatting was requested but no files were provided");
        }
    }
    ...
    public void inPlaceDryRun() {
        try {
            ...
            assertThat(e).hasMessageContaining("cannot use --dry-run and --in-place at the same time");
        }
    }
    ...
    public void assumeFileNameOnlyWorksWithStdin() {
        try {
            ...
            assertThat(e).hasMessageContaining("--assume-filename is only supported when formatting standard input");
        }
    }
}
